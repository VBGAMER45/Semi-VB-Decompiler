...
End If
    ...
    frmMain.txtCode.Text = strBuffer
End Sub
Public Function GetApiDeclareBlock() As String
'*****************************
'Build the "Private Declare Function ..." block for the declared (DllFunctionCall)
    ...
    For i = 0 To UBound(gApiList) - 1
        ...
        If Len(def) > 0 Then
            ...
            Else
                ...
                s = s & "Private Declare Function " & def & " Lib " & cQuote & gApiList(i).strLibraryName & cQuote & " () As Long" & vbCrLf
            End If
        End If
    Next
...
On Error GoTo nofile:
       ...
       F = FreeFile
        Open FilePath For Output As #F
            ...
            'Reconstruct the Win32 API Declare block (DllFunctionCall imports).
