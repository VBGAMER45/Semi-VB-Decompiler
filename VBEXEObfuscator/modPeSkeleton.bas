...
'Used to save info
Public Type ControlSaveInfoType
    Length As Long
    Offset As Long
End Type
Global ControlSaveInfo() As ControlSaveInfoType
Global ObjectSaveInfo() As Long
...
Public Function CheckHeader() As Boolean
    ...
    If OptHeader.DataDirectory(14).Address <> 0 Then
        ...
        MsgBox "This is a VB.NET compiled file and is not supported right now... Check .netconsole.txt", vbExclamation
        VBVersion = 7
    End If
...
'*****************************
      ...
      GetPtrFromRVA2 = iRVA
End Function
Function ReturnVBVersionNe(iFileNumber As Long) As Integer
    Dim lNum1 As Long
    Dim lNum2 As Long
