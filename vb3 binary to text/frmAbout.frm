...
Begin VB.Form frmAbout 
   ...
   Caption         =   "About VB 1/2/3 Binary Form to Text Converter"
   ClientHeight    =   4095
   ClientLeft      =   2340
   ClientTop       =   1935
   ClientWidth     =   5730
   ...
   Begin VB.Label lblDescription 
      ...
      Caption         =   "Transforms Visual Basic 1/2/3 Binary forms to text without needing Visual Basic installed."
      ForeColor       =   &H00000000&
      Height          =   450
      Left            =   1080
      TabIndex        =   3
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "VB 1/2/3 Binary Form To Text Converter               by VisualBasicZone.com"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   8.25
         Charset         =   0
