Attribute VB_Name = "modDirectoryListbox"
'***********************************
...
Public Function ProccessDirectoryListBox(ByVal F As Integer, ByVal Opcode As Byte) As Long
    ...
    Select Case Opcode
        ...
        Case Else
            ...
            Call AddError("Error_Unknown Opcode_ProcessDirectoryListBox: Opcode: " & Opcode & " Offset: " & Loc(F))
            bFirstFF = True
...
Exit Function
errHandle:
    Call AddError("Error_ProcessDirectoryListBox: Opcode: " & Opcode & " Offset: " & Loc(F) & " Description= " & Err.Description)
