...
Public Function ProccessListBox(ByVal F As Integer, ByVal Opcode As Byte) As Long
    ...
    Select Case Opcode
        ...
        Case 28 'Columns
            Get #F, , iData
            Call frmMain.AddText("Columns = " & iData)
        Case 29 'MultiSelect
            Get #F, , bData
        ...
        Case Else
            ...
            Call AddError("Error_Unknown Opcode_ProcessListBox: Opcode: " & Opcode & " Offset: " & Loc(F))
            bFirstFF = True
...
Exit Function
errHandle:
    Call AddError("Error_ProcessListBox: Opcode: " & Opcode & " Offset: " & Loc(F) & " Description= " & Err.Description)
