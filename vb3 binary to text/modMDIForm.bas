...
Public Function ProccessMDIForm(ByVal F As Integer, ByVal Opcode As Byte) As Long
    ...
    Select Case Opcode
        ...
        Case 12
            Get #F, , bData
            Call frmMain.AddText("ScrollBars  = 0")
        ...
        Case Else
            ...
            Call AddError("Error_Unknown Opcode_ProcessMDIForm: Opcode: " & Opcode & " Offset: " & Loc(F))
            bFirstFF = True
...
Exit Function
errHandle:
    Call AddError("Error_ProcessMDIForm: Opcode: " & Opcode & " Offset: " & Loc(F) & " Description= " & Err.Description)
