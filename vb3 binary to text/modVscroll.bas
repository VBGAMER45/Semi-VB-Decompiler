...
Public Function ProccessVscroll(ByVal F As Integer, ByVal Opcode As Byte) As Long
    ...
    Select Case Opcode
        ...
        Case Else
            ...
            Call AddError("Error_Unknown Opcode_ProcessVscroll: Opcode: " & Opcode & " Offset: " & Loc(F))
            bFirstFF = True
...
Exit Function
errHandle:
    Call AddError("Error_ProcessVscroll: Opcode: " & Opcode & " Offset: " & Loc(F) & " Description= " & Err.Description)
